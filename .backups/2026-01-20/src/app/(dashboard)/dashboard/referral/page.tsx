        ...
        <div className="container mx-auto px-4 lg:px-8 py-8 space-y-8 min-h-screen bg-[#020617]">
            ...
            <div className="flex items-center justify-between p-6 bg-slate-900/50 backdrop-blur-md border border-slate-800 rounded-2xl shadow-lg relative overflow-hidden group">
                ...
                <div className="flex items-center gap-4 relative z-10">
                    <div className="p-3 bg-indigo-500/20 rounded-xl border border-indigo-500/30 text-indigo-400 shadow-[0_0_15px_rgba(99,102,241,0.5)]">
                    ...
                    <div>
                        ...
                        <p className="text-slate-400 font-medium">Invite friends and earn rewards together.</p>
                    </div>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 space-y-6">
                    {/* Hero Card */}
                    <div className="p-8 relative overflow-hidden rounded-2xl border border-indigo-500/30 shadow-2xl bg-[#0F172A] group">
                        ...
                        <div className="relative z-10">
                            <h2 className="text-2xl font-bold mb-3 text-white">Share the wealth</h2>
                            <p className="text-slate-300 mb-8 max-w-lg leading-relaxed">
                                Earn <span className="font-bold text-emerald-400">₹500</span> for every friend who joins and makes their first investment. They get exclusive access to premium strategies.
                            </p>

                            <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center">
                                <div className="bg-slate-950/50 backdrop-blur-md rounded-xl p-2 pl-5 flex items-center border border-indigo-500/30 w-full sm:w-auto shadow-inner">
                                    <code className="font-mono text-xl font-bold tracking-widest text-indigo-400">
                                        {data?.myReferralCode || "GENERATING..."}
                                    </code>
                                    <button
                                        onClick={copyToClipboard}
                                        className="ml-6 p-2.5 hover:bg-white/10 rounded-lg transition-colors text-slate-400 hover:text-white"
                                        title="Copy Code"
                                    >
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div className="p-6 rounded-2xl bg-[#0F172A] border border-slate-800 shadow-xl flex items-center gap-5 relative overflow-hidden">
                            <div className="w-14 h-14 rounded-full bg-emerald-500/10 border border-emerald-500/20 flex items-center justify-center text-emerald-400 shadow-[0_0_15px_rgba(16,185,129,0.2)]">
                                <Users className="w-7 h-7" />
                            </div>
                            <div>
                                <p className="text-sm text-slate-400 font-medium uppercase tracking-wide">Total Referrals</p>
                                <p className="text-3xl font-bold text-white mt-1">{data?.count || 0}</p>
                            </div>
                        </div>
                        <div className="p-6 rounded-2xl bg-[#0F172A] border border-slate-800 shadow-xl flex items-center gap-5 relative overflow-hidden">
                            <div className="w-14 h-14 rounded-full bg-amber-500/10 border border-amber-500/20 flex items-center justify-center text-amber-400 shadow-[0_0_15px_rgba(245,158,11,0.2)]">
                                <TrendingUp className="w-7 h-7" />
                            </div>
                            <div>
                                <p className="text-sm text-slate-400 font-medium uppercase tracking-wide">Total Earnings</p>
                                <p className="text-3xl font-bold text-white mt-1">₹{data?.totalEarnings?.toLocaleString() || 0}</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                {/* Right: List */}
                <div className="bg-[#0F172A] border border-slate-800 rounded-2xl p-6 shadow-xl h-fit">
                    <h3 className="font-bold text-lg mb-6 flex items-center gap-2 text-white border-b border-slate-800 pb-4">
