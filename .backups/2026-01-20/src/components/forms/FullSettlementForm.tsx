...
export default function FullSettlementForm() {
    ...
    return (
        <div className="bg-[#0F172A] rounded-2xl border border-red-500/30 shadow-[0_0_15px_rgba(239,68,68,0.1)] p-6 relative overflow-hidden group mt-6">
            ...
            <form onSubmit={handleFullSettlement} className="space-y-4 relative z-10">
                <div>
                    ...
                    <input
                        type="number"
                        min="0"
                        className="w-full px-3 py-2 bg-slate-900 border border-slate-700 text-white rounded-lg focus:ring-2 focus:ring-red-500/50 outline-none transition-all placeholder:text-slate-600"
                        placeholder="0"
                        value={threshold}
